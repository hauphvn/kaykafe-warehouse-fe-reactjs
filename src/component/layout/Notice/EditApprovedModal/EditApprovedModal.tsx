...
interface EditApprovedModalPropsI {
  onCancelApproval: (e?: any) => void;
  onOkApproval: () => void;
  isShow: boolean;
  idEdit: string;
}
function EditApprovedModal(props: EditApprovedModalPropsI) {
      ...
      <div className={'notice-approved-edit-root'}>
        <div className={'notice-approved-detail-module-root'}>
          <div className="form">
            ...
            <Input label={'書類名（代表）'} className="text-item" value={data?.representative_name} disable={true} />
            <DatePickers
